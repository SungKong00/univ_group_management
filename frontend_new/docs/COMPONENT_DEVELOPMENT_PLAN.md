...
| 컴포넌트 | 설명 | 필요 이유 |
|---------|------|----------|
| **AppBadge** | 상태/카운트 표시 | 알림 개수, 상태 태그 표시 |
| **AppDialog** | 모달 다이얼로그 | 확인, 경고, 입력 모달 |
| **AppToast** | 토스트 알림 | 성공/에러/정보 피드백 |
| **AppDropdown** | 드롭다운 선택기 | 폼 입력, 필터링 |
| **AppChip** | 태그/필터 칩 | 라벨, 필터 선택 |
| **AppTooltip** | 툴팁 | 아이콘/버튼 설명 |
...
| 2 | AppToast | 중간 | 없음 |
| 3 | AppTooltip | 중간 | 없음 |
| 4 | AppDialog | 중간 | AppButton |
| 5 | AppChip | 낮음 | 없음 |
| 6 | AppDropdown | 높음 | AppInput |
