  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: ColorTokens.backgroundLevel1,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              title: 'Content Tabs',
              subtitle: '탭 개수별 샘플 + indicator 커스터마이징',
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _buildSubtitle('2개 탭 (기본)'),
                  const SizedBox(height: 12),
                  AppTabs(
                    tabs: const [
                      AppTabItem(label: '개요'),
                  ...
                  const SizedBox(height: 32),
                  _buildSubtitle('3개 탭 (indicator 높이 2px)'),
                  const SizedBox(height: 12),
                  AppTabs(
                    tabs: const [
                  ...
                  const SizedBox(height: 32),
                  _buildSubtitle('5개 탭 (animation 느리게)'),
                  const SizedBox(height: 12),
                  AppTabs(
                    tabs: const [
                      AppTabItem(label: '전체'),
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      AppFeatureCard(
                        ...
                        subtitle: 'Automate pull requests and commit workflows',
                        icon: Icons.code,
                        width: 280,
                        onTap: () {
                  ...
                  Wrap(
                    ...
                    children: [
                      AppFeatureCard(
                        ...
                        image: Container(
                          ...
                          decoration: BoxDecoration(
                            color: ColorTokens.backgroundLevel3,
                      ...
                      AppFeatureCard(
                        ...
                        subtitle: '100+ ways to enhance your Linear experience',
                        width: 336,
                        image: Container(
                          height: 200,
                          decoration: BoxDecoration(
                  ...
                  Wrap(
                    ...
                    children: [
                      AppFeatureCard(
                        ...
                        subtitle: 'Bridge the gap between engineering and design',
                      ...
                      AppFeatureCard(
                        ...
                        subtitle: 'Build your own add-ons with the Linear API',
                      ...
                      AppFeatureCard(
                        ...
                        subtitle: 'Enterprise-ready security at every layer',
                        icon: Icons.security,
                        width: 220,
                        onTap: () {
  ...
  Widget _buildSection({
    ...
    return Column(
      ...
      children: [
        Text(
          title,
          style: TypographyTokens.title3.copyWith(
            color: ColorTokens.textPrimary,
