class AppConstants {
  // API 관련 상수
  // 백엔드 보안 설정 및 라우팅에 맞춰 v1을 제거했습니다.
  ...
  // OAuth / Google Sign-In 설정 (필요 시 교체)
  static const String googleWebClientId = '264783921782-imbndkfntp44qurjvjdlrk0r342ojp83.apps.googleusercontent.com';
  static const String googleIosClientId = '<SET_IOS_CLIENT_ID>'; // iOS 필요 시
  static const String googleAndroidClientId = '<SET_ANDROID_CLIENT_ID>'; // Android 필요 시
...
class ApiEndpoints {
  ...
  static const String googleLogin = '${AppConstants.authEndpoint}/google';
