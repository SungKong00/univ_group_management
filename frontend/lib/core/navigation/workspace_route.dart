...
class WorkspaceRoute with _$WorkspaceRoute {
  /// Home view route
  const factory WorkspaceRoute.home({required int groupId}) = HomeRoute;
  ...
  /// Calendar view route
  const factory WorkspaceRoute.calendar({required int groupId}) = CalendarRoute;

  /// Admin view route
  const factory WorkspaceRoute.admin({required int groupId}) = AdminRoute;
