            ...
            GroupJoinRequestResponse(
                ...
                user =
                    UserSummaryResponse(
                        ...
                        profileImageUrl = saved.user.profileImageUrl,
                    ),
    ...
    fun reviewGroupRequest(
        ...
        val resp =
            SubGroupRequestResponse(
                ...
                requester =
                    UserSummaryResponse(
                        id = saved.requester.id,
                        name = saved.requester.name,
                        email = saved.requester.email,
                        profileImageUrl = saved.requester.profileImageUrl,
                    ),
                parentGroup =
                    GroupSummaryResponse(
