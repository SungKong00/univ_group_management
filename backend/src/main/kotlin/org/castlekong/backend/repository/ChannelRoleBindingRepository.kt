...
interface ChannelRoleBindingRepository : JpaRepository<ChannelRoleBinding, Long> {
     ...
     */
    fun findByChannelIdAndGroupRoleIdIn(
        channelId: Long,
        groupRoleIds: List<Long>,
    ): List<ChannelRoleBinding>

    /**
     * 특정 채널에 바인딩된 역할 ID 목록 조회
     */
    @Query("SELECT b.groupRole.id FROM ChannelRoleBinding b WHERE b.channel.id = :channelId")
    fun findRoleIdsByChannelId(
    ...
    fun findChannelIdsByGroupRoleInGroup(
     ...
     */
    fun existsByChannelIdAndGroupRoleId(
        channelId: Long,
        groupRoleId: Long,
    ): Boolean
     ...
     * 특정 채널과 역할의 바인딩 조회
     */
    fun findByChannelIdAndGroupRoleId(
        channelId: Long,
        groupRoleId: Long,
    ): ChannelRoleBinding?
     ...
     * 특정 채널에서 바인딩 삭제
     */
    fun deleteByChannelIdAndGroupRoleId(
        channelId: Long,
        groupRoleId: Long,
    )
