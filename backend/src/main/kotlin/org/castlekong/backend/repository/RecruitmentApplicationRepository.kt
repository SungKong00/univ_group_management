...
interface RecruitmentApplicationRepository : JpaRepository<RecruitmentApplication, Long> {
    ...
    """)
    fun findActiveRecruitmentIdsByApplicantId(@Param("applicantId") applicantId: Long): List<Long>
    ...
    """)
    fun findByGroupId(@Param("groupId") groupId: Long): List<RecruitmentApplication>
    ...
    """)
    fun countPendingApplicationsByGroupId(@Param("groupId") groupId: Long): Long
}