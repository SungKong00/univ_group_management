...
class PermissionService(
    ...
    fun getEffective(groupId: Long, userId: Long, systemRolePermissions: (String) -> Set<GroupPermission>): Set<GroupPermission> {
    ...
    private fun computeEffective(groupId: Long, userId: Long, systemRolePermissions: (String) -> Set<GroupPermission>): Set<GroupPermission> {
