...
CREATE INDEX IF NOT EXISTS idx_group_roles_priority ON group_roles(priority);
...
CREATE INDEX IF NOT EXISTS idx_posts_channel_created_pinned ON posts(channel_id, created_at, is_pinned);
