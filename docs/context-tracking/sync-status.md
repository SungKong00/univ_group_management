...
**마지막 업데이트**: 2025-10-07 (백엔드 데이터 초기화 리팩토링 및 프론트엔드 UI 개선)
**총 문서 수**: 32개
**동기화 완료**: 32개 (100%)
**업데이트 필요**: 0개 (0%)
...
| `database-reference.md` | ✅ 최신 | 2025-10-07 | `현재` | data.sql 정책 변경 및 자동화 설명 추가 |
...
| `navigation-and-page-flow.md` | ✅ 최신 | 2025-10-07 | `현재` | 그룹 관리 페이지 라우팅 추가 |
...
| `sync-status.md` | ✅ 최신 | 2025-10-07 | `현재` | 신규 생성 (현재 파일) |
