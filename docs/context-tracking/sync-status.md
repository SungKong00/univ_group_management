...
| `frontend-guide.md` | ✅ 최신 | 2025-10-06 | `현재` | CollapsibleContent 위젯 추가 |
| `frontend-implementation-status.md` | ✅ 최신 | 2025-10-06 | `현재` | 댓글창 UX 개선 현황 반영 |
...
| `workspace-pages.md` | ✅ 최신 | 2025-10-06 | `현재` | 댓글창 게시글 미리보기 명세 추가 |
