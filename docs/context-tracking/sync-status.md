...
**마지막 업데이트**: 2025-10-08 (권한 이름 변경 및 워크스페이스 로직 개선)
**총 문서 수**: 36개
**동기화 완료**: 36개 (100%)
**업데이트 필요**: 0개 (0%)
...
| `api-reference.md` | ✅ 최신 | 2025-10-08 | `현재` | ADMIN_MANAGE -> MEMBER_MANAGE 변경 |
...
| 파일명 | 상태 | 마지막 동기화 | 관련 커밋 | 비고 |
|--------|------|---------------|-----------|------|
| `context-update-log.md` | ✅ 최신 | 2025-10-08 | `현재` | 권한 변경 및 리팩토링 로그 추가 |
| `pending-updates.md` | ✅ 최신 | 2025-10-06 | `현재` | 컨트롤러 테스트 문서화 완료 기록 |
| `sync-status.md` | ✅ 최신 | 2025-10-08 | `현재` | 현재 파일 (변경사항 반영) |
