...
**마지막 업데이트**: 2025-10-24 (깨진 링크 63개 수정 완료)
**총 문서 수**: 83개
**동기화 완료**: 83개 (100%)
**업데이트 필요**: 0개 (0%)
...
| 파일명 | 상태 | 마지막 동기화 | 비고 |
|--------|------|---------------|------|
| `design-system.md` | ✅ 최신 | 2025-10-09 | 전체 디자인 시스템 개요 |
| `design-principles.md` | ✅ 최신 | 2025-10-24 | 디자인 철학 및 패턴 |
| `design-tokens.md` | ✅ 최신 | 2025-10-24 | 구체적인 디자인 값 |
| `color-guide.md` | ✅ 최신 | 2024-09-28 | 컬러 팔레트 및 사용 지침 |
| `responsive-design-guide.md` | ✅ 최신 | 2025-10-09 | 반응형 레이아웃 상세 |

### `/docs/ui-ux/pages/` - 페이지별 명세 (12개)
| 파일명 | 상태 | 마지막 동기화 | 비고 |
|--------|------|---------------|------|
| `authentication-pages.md` | ✅ 최신 | 2024-09-28 | 인증 페이지 |
| `navigation-and-page-flow.md` | ✅ 최신 | 2025-10-07 | 기본 네비게이션 구조 |
| `workspace-pages.md` | ✅ 최신 | 2025-10-17 | 워크스페이스 전체 구조 |
| `workspace-channel-view.md` | ✅ 최신 | 2025-10-24 | 채널 뷰 (게시글/댓글) |
| `workspace-admin-pages.md` | ✅ 최신 | 2025-10-24 | 워크스페이스 관리 페이지 |
| `workspace-navigation-flow.md` | ✅ 최신 | 2025-10-24 | 워크스페이스 네비게이션 플로우 |
| `home-page.md` | ✅ 최신 | 2024-09-28 | 홈 페이지 |
| `channel-pages.md` | ✅ 최신 | 2025-10-07 | 채널 페이지 |
| `my-activity-page.md` | ✅ 최신 | 2024-09-28 | 내 활동 페이지 |
| `recruitment-pages.md` | ✅ 최신 | 2024-09-28 | 모집 페이지 개요 |
| `recruitment-user-pages.md` | ✅ 최신 | 2025-10-24 | 사용자 모집 페이지 |
| `recruitment-admin-pages.md` | ✅ 최신 | 2025-10-24 | 관리자 모집 페이지 |
