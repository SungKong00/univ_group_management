...
**마지막 업데이트**: 2025-10-06 (캘린더 시스템 설계 결정사항 문서화)
**총 문서 수**: 31개
**동기화 완료**: 31개 (100%)
**업데이트 필요**: 0개 (0%)
...
| `calendar-design-decisions.md` | ✅ 최신 | 2025-10-06 | `현재` | 신규 생성 (7가지 DD) |
...
| 파일명 | 상태 | 마지막 동기화 | 관련 커밋 | 비고 |
|--------|------|---------------|-----------|------|
| `backend-guide.md` | ✅ 최신 | 2025-10-06 | `현재` | 캘린더 구현 가이드 추가 |
| `frontend-guide.md` | ✅ 최신 | 2025-10-05 | `현재` | 게시글/댓글 컴포넌트 패턴 추가 |
| `frontend-implementation-status.md` | ✅ 최신 | 2025-10-06 | `현재` | 캘린더 구현 현황 섹션 추가 |
| `api-reference.md` | ✅ 최신 | 2025-10-06 | `현재` | 캘린더 API 계획 섹션 추가 |
| `database-reference.md` | ✅ 최신 | 2025-10-06 | `현재` | 캘린더 시스템 테이블 섹션 추가 |
...
### 최근 7일간 변화
- **신규 문서**: 10개 (컨벤션, 추적 시스템, 마스터 워크플로우, 장소 관리, 캘린더 설계 결정)
- **업데이트된 문서**: 30개
- **동기화 지연**: 0일 (평균)
- **최대 지연**: 0일
