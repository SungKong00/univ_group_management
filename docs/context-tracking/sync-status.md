...
**마지막 업데이트**: 2025-11-02 (캘린더 통합 구현 - 그룹 홈 월간 뷰 + 개인 캘린더 주간 뷰)
**총 문서 수**: 98개
**동기화 완료**: 98개 (100%)
**업데이트 필요**: 0개 (0%)
...
| `components.md` | ✅ 최신 | 2025-11-02 | CompactMonthCalendar 추가 (111줄) |
...
**주요 업데이트 (2025-11-02)**:
- **캘린더 통합 구현** (그룹 홈 월간 뷰 + 개인 캘린더 주간 뷰)
  ...
  - 장소 운영시간 다이얼로그 레이아웃 수정 (OutlinedLinkButton 동적 너비)
