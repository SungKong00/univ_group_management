...
**마지막 업데이트**: 2025-10-06 (컨트롤러 통합 테스트 패턴 문서화)
**총 문서 수**: 30개
**동기화 완료**: 29개 (97%)
**업데이트 필요**: 1개 (3%)
...
| `permission-system.md` | ✅ 최신 | 2025-10-06 | `현재` | 캘린더 권한 섹션 추가 |
| `workspace-channel.md` | ✅ 최신 | 2024-09-28 | `86b8cf6` | |
| `user-lifecycle.md` | ✅ 최신 | 2024-09-28 | `86b8cf6` | |
| `calendar-system.md` | ✅ 최신 | 2025-10-06 | `현재` | 100라인 원칙 준수 재구성 |
| `calendar-place-management.md` | ✅ 최신 | 2025-10-06 | `현재` | 신규 생성 (장소 관리 시스템) |
...
| 파일명 | 상태 | 마지막 동기화 | 관련 커밋 | 비고 |
|--------|------|---------------|-----------|------|
| `backend-guide.md` | ✅ 최신 | 2025-10-06 | `현재` | 컨트롤러 테스트 가이드 추가 |
| `frontend-guide.md` | ✅ 최신 | 2025-10-05 | `현재` | 게시글/댓글 컴포넌트 패턴 추가 |
| `frontend-implementation-status.md` | ✅ 최신 | 2025-10-06 | `현재` | 캘린더 구현 현황 섹션 추가 |
...
| 파일명 | 상태 | 마지막 동기화 | 관련 커밋 | 비고 |
|--------|------|---------------|-----------|------|
| `context-update-log.md` | ✅ 최신 | 2025-10-06 | `현재` | MeControllerTest 작업 로그 추가 |
| `pending-updates.md` | ✅ 최신 | 2025-10-06 | `현재` | 컨트롤러 테스트 문서화 완료 기록 |
| `sync-status.md` | ✅ 최신 | 2025-10-06 | `현재` | 신규 생성 (현재 파일) |
...
### 최근 7일간 변화
- **신규 문서**: 9개 (컨벤션, 추적 시스템, 마스터 워크플로우, 장소 관리)
- **업데이트된 문서**: 25개
- **동기화 지연**: 1일 (평균)
